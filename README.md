...
This repository accompanies the letter "On the Distance Properties of Huffman Sequences" [1], which studies distances between sequences sharing a common aperiodic autocorrelation (with an emphasis on Huffman sequences).
